// mydified from https://github.com/codebandits/react-app-rewire-css-modules
...
const findRule2 = (rulesSource, ruleMatcher) => {
  // console.log(rulesSource, ruleMatcher);
  const { index, rules } = findIndexAndRules2(rulesSource, ruleMatcher)
  return rules[index]
}
...
module.exports = function (config, env) {
  ...
  // console.log('hr=========================', cssModulesRule);
  cssRule.exclude = /\.module\.css$/
  const cssModulesRuleCssLoader = findRule2(cssModulesRule, cssLoaderMatcher)
